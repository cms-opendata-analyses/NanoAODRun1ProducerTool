...
# For 2015 data
#goodJSON = 'files/Cert_13TeV_16Dec2015ReReco_Collisions15_25ns_JSON_v2.txt'
...
#files = FileUtils.loadListFromFile('files/CMS_Run2015D_MuonEG_AOD_16Dec2015-v1_60000_file_index.txt') 
#files = FileUtils.loadListFromFile('files/CMS_Run2015D_SingleElectron_AOD_08Jun2016-v1_10000_file_index.txt')
#files = FileUtils.loadListFromFile('files/CMS_Run2015D_Charmonium_AOD_16Dec2015-v1_50000_file_index.txt')
...
process.source = cms.Source("PoolSource",
                            #fileNames = readFiles
                            # 2015 data
                            #fileNames = cms.untracked.vstring('root://eospublic.cern.ch//eos/opendata/cms/Run2015D/MuonEG/AOD/16Dec2015-v1/60000/00135C5C-4AAD-E511-A5DD-003048FFCC0A.root')
                            # 2015 DY MC
                            fileNames = cms.untracked.vstring('root://eospublic.cern.ch//eos/opendata/cms/mc/RunIIFall15MiniAODv2/DYJetsToLL_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8/MINIAODSIM/PU25nsData2015v1_76X_mcRun2_asymptotic_v12_ext1-v1/10000/004544CB-6DD8-E511-97E4-0026189438F6.root')
